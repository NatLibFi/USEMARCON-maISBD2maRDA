...
my $inputfile = ReadData ("Termit.xlsx") || die $!;
my $outputfile = "Mediatyypit_337.tbl"; # An example
my $preamble = "Mediatyypit_337.tbl -- Mediatyyppifraasien käännös (RDA --> ISBD)"; # An example
my $default_value = "COPY"; # COPY copies input value to output as is, if value is not found in Look Up Table

my $sheet = "2";
my $inputvalue_firstcell = "B2";
my $inputvalue_lastcell = "B10";
my $outputvalue_firstcell = "A2";
my $outputvalue_lastcell = "A10";
